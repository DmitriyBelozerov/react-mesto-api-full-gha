        ...
        <div className={`popup popup_type_sign`}>
            <div className={`form form_type_sign`}>
                ...
                <form className="form__sending" action="#" name={`${props.name}`} noValidate onSubmit={handleSubmit}>
                    ...
                    <input id="inputEmail" className="form__input form__input_type_sign" type="text" value={email || ''} onChange={handleChangeEmail}
                        name="inputName" placeholder="Email" minLength="2" maxLength="40" required />
                    <input id="inputPassword" className="form__input form__input_type_sign" type="password" value={password || ''} onChange={handleChangePassword}
